...
export const Preview = memo(() => {
  ...
  useEffect(() => {
    console.log('[Preview Component] 🔄 Preview state changed:', {
      activePreview,
    ...
    if (!activePreview) {
      console.log('[Preview Component] ⚠️  No active preview available');
    ...
    console.log('[Preview Component] ✅ Setting iframe URL:', baseUrl);
    setIframeUrl(baseUrl);
    setDisplayPath('/');
  }, [activePreview, previews, activePreviewIndex]);
