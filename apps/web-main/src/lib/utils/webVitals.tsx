...
declare global {
  interface Window {
    ...
    scheduler?: {
      postTask: (callback: () => void, options: any) => void;
    };
  }
}
  ...
  const getOverallScore = () => {
    ...
    const scores = metrics.map((metric) => {
      switch (metric.rating) {
        case 'good': return 100 as number;
        case 'needs-improvement': return 50 as number;
        case 'poor': return 0 as number;
        default: return 0 as number;
      }
    });
