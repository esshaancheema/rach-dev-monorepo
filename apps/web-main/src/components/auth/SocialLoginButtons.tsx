...
export default function SocialLoginButtons({ redirectTo = '/dashboard', className }: SocialLoginButtonsProps) {
...
// Export individual provider components for flexibility
export function GoogleLoginButton({ redirectTo = '/dashboard', className }: SocialLoginButtonsProps) {
  ...
  return (
    <div className={className}>
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full bg-white border-gray-300 text-gray-700 hover:bg-gray-50 hover:shadow-md transition-all duration-200"
      ...
      >
        {loading ? (
          ...
          <span className="mr-2"><GoogleLoginButton /></span>
        )}
...
export function GitHubLoginButton({ redirectTo = '/dashboard', className }: SocialLoginButtonsProps) {
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState<string | null>(null);
  ...
  return (
    <div className={className}>
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full bg-gray-900 text-white hover:bg-gray-800 hover:shadow-md transition-all duration-200"
