...
describe('Authentication E2E Tests', () => {
    ...
    describe('POST /api/auth/login', () => {
        ...
        it('should login with valid credentials', async () => {
            ...
            const refreshTokenCookie = response.headers['set-cookie'].find((cookie) => cookie.startsWith('refresh_token='));
    ...
    describe('POST /api/auth/refresh', () => {
        ...
        beforeEach(async () => {
            ...
            refreshTokenCookie = cookies.find((cookie) => cookie.startsWith('refresh_token='));
        });
    ...
    describe('POST /api/auth/logout', () => {
        ...
        it('should logout successfully', async () => {
            ...
            if (setCookieHeader) {
                const clearCookie = setCookieHeader.find((cookie) => cookie.includes('refresh_token=') && cookie.includes('Max-Age=0'));
